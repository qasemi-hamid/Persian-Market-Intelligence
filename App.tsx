      ...
      <main className="max-w-4xl mx-auto px-5 py-6">
        {loading && !analysis ? (
          <div className="flex flex-col items-center justify-center py-32">
            ...
            <p className="mt-4 text-slate-500 font-medium animate-pulse text-[11px] tracking-tight text-center">
              در حال استخراج الگوریتم‌های بازار و تحلیل عمیق...<br/>
                ...
                <div key={idx} className="bg-slate-800/80 border border-slate-700/60 rounded-2xl overflow-hidden shadow-xl transition-all hover:bg-slate-800/90 hover:border-cyan-500/20 group">
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <div className="bg-slate-900 px-4 py-4 rounded-xl border border-cyan-500/20 transition-all group-hover:border-cyan-500/40 shadow-inner relative overflow-hidden">
                      ...
                      <div className="flex flex-col gap-3">
                        <div className="flex items-center justify-between">
                          <span className="text-[10px] text-cyan-500/70 font-bold uppercase tracking-widest flex items-center gap-1.5">
                            <ArrowRightLeft className="w-3 h-3" /> پیشنهاد اجرایی معامله
                          </span>
                          <div className="flex items-center gap-1.5 bg-emerald-500/10 border border-emerald-500/20 px-2 py-0.5 rounded-lg">
                            <ProfitIcon className="w-3 h-3 text-emerald-500" />
                            <span className="text-[10px] font-bold text-emerald-500">سود: {strat.potentialProfit}</span>
                          </div>
                        </div>
                    ...
                    <div className="pt-3 flex items-center justify-between border-t border-white/5">
                      ...
                      <button className="text-[9px] font-bold text-cyan-500/80 hover:text-cyan-400 flex items-center gap-1 transition-colors uppercase tracking-wider">
                        Open Full Chart <Compass className="w-2.5 h-2.5" />
                      </button>
                    </div>
                  </div>
                </div>
            ...
            <footer className="pt-8 border-t border-slate-800/50 text-center">
              <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-3 inline-block max-w-xs shadow-inner">
                <p className="text-[9px] leading-4 text-slate-500 font-medium">
                  سلب مسئولیت: این تحلیل‌ها بر اساس مدل‌های آماری و ریاضی استخراج شده است. بازارهای مالی ایران دارای ریسک‌های پیش‌بینی نشده هستند.
                </p>
              </div>
            </footer>
          </div>
